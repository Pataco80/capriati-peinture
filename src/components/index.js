...
export { default as BcgImage } from './BcgImage'
...
export { default as PartenersItem } from './PartenersItem/PartenersItem'
...
export { default as VideoBcg } from './VideoBcg'
...
export { default as TeamCadres } from './TeamCadres/TeamCadres'
...
export { Button, ButtonLink, ButtonForm, GatsbyButtonLink } from './styledElements/ButtonsStyled'

export { BannerStyled, BannerStyledCenter } from './styledElements/BannerStyled'
