...
const aboutPage = ({data}) => {
  ...
  return (
    <Layout>
      <SEO title='A Propos de Nous' description="A Propos de l'entrerise Capriati S.A., son histoire, son équipe et ces partenaires" keywords="A Propos, entreprise peinture, entreprise familiale, entretien, rénovation peinture, historique" image='about'/>
